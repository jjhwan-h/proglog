...
import (
	...
	"github.com/jjhwan-h/proglog/internal/auth"
	"github.com/jjhwan-h/proglog/internal/config"
	"github.com/jjhwan-h/proglog/internal/log"
...
/*
클라이언트와 서버를 이용하여 생산과 소비가 이루어지는지,
로그에 레코드를 추가하고 다시 소비하는지를 확인
*/
